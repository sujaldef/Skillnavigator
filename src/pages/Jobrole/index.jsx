...
const JobRole = () => {
  ...
  const aiSuggestions = useMemo(
    () => ({
      ...
      beginner:
        'Perfect starting point for beginners with foundational resources',
    }),
    [],
  );
  ...
  useEffect(() => {
    const fetchJobRoles = async () => {
      ...
      try {
        ...
        const uniqueJobRoles = [...new Set(fieldData)].sort((a, b) =>
          a.localeCompare(b),
        );
  ...
  useEffect(() => {
    const filtered = state.jobRoles
      .filter((role) =>
        role.toLowerCase().includes(state.searchTerm.toLowerCase()),
      )
  ...
  const handleKnowYourLevel = useCallback(
    (event) => {
  ...
  const handleFetchRoadmap = useCallback(
    (event) => {
      event.preventDefault();
  ...
  const displayFieldName =
    fieldName?.replace(/-/g, ' ').toUpperCase() || 'CAREER PATH';
            ...
            <div className="bg-gradient-to-br from-[#2E4057] to-[#1A2A44] rounded-3xl p-6 md:p-8 shadow-2xl border border-[#00FF88]/10">
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="text-xs md:text-sm text-gray-400 bg-[#1A2A44]/50 px-3 py-1 rounded-full">
                  {state.filteredJobRoles.length}{' '}
                  {state.filteredJobRoles.length === 1 ? 'role' : 'roles'}
                </div>
              </div>
                      ...
                      {displayedJobRoles.length > 0 ? (
                        displayedJobRoles.map((role, index) => (
                          <motion.button
                            ...
                            whileTap={{ scale: 0.98 }}
                            className={`relative p-4 rounded-xl font-medium transition-all duration-300 overflow-hidden group ${
                        ...
                        >
                          ...
                          <p className="text-gray-500 text-sm">
                            Try adjusting your search or browse all roles
                          </p>
                          {state.searchTerm && (
                            <button
                              onClick={() =>
                  ...
                  {state.filteredJobRoles.length > 6 && (
                    ...
                    >
                      ...
                      <motion.svg
                        ...
                        transition={{
                          duration: 1,
                          repeat: state.showAllRoles ? 0 : Infinity,
                        }}
              ...
              >
                ...
                <div className="relative z-10 flex flex-col h-full justify-between">
                  <div>
                    <div className="flex items-center justify-between mb-6">
                      <div className="w-14 h-14 md:w-16 md:h-16 bg-gradient-to-br from-[#00FF88] to-[#00CC70] rounded-2xl flex items-center justify-center shadow-lg">
                        <svg
                          className="w-7 h-7 md:w-8 md:h-8 text-[#1A2A44]"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
                    ...
                    <p className="text-gray-300 mb-6 text-sm leading-relaxed">
                      Evaluate your current knowledge level with our AI-powered
                      assessment. Get personalized insights and recommendations
                  ...
                  <motion.button
                    ...
                    className={`w-full py-3 md:py-4 rounded-xl font-bold text-base transition-all duration-300 flex items-center justify-center gap-2 group ${
              ...
              >
                ...
                <div className="relative z-10 flex flex-col h-full justify-between">
                  <div>
                    ...
                    <p className="text-gray-300 mb-6 text-sm leading-relaxed">
                      Begin your structured learning journey with curated
                      resources tailored to your skill level. Choose your
                      ...
                      <div className="max-h-64 overflow-y-auto pr-2 space-y-2 custom-scrollbar">
                        {levels.map((level, index) => (
                          <motion.button
                            ...
                            whileTap={{ scale: 0.98 }}
                            className={`w-full p-3 md:p-4 rounded-xl transition-all duration-300 flex items-center justify-between group/level ${
                          ...
                          >
                            <div className="flex items-center gap-3">
                              ...
                              <div className="text-left">
                                ...
                                <div
                                  className={`text-xs ${state.selectedLevel === level.name ? 'opacity-80' : 'text-gray-400'}`}
                                >
                                  {level.description}
                                </div>
                              </div>
                  ...
                  <motion.button
                    ...
                    className={`w-full py-3 md:py-4 rounded-xl font-bold text-base transition-all duration-300 flex items-center justify-center gap-2 group ${
                      state.selectedJobRole && state.selectedLevel
                        ? 'bg-gradient-to-r from-[#00FF88] to-[#00CC70] text-[#1A2A44] hover:shadow-lg hover:shadow-[#00FF88]/30'
                        : 'bg-gray-600 text-gray-400 cursor-not-allowed opacity-60'
                    }`}
                  >
