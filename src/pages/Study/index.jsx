        ...
        <div className="w-80 hidden md:flex flex-col border-r border-[#1E293B] bg-[#0F172A]">
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-2 custom-scrollbar">
            {skills.map((skill, idx) => (
              <div
                key={idx}
                className="rounded-xl overflow-hidden border border-[#2E4057] bg-[#1A2A44]/30"
              >
                {/* Skill Header */}
                <div
            ...
            {!selectedSkill ? (
              ...
              <div className="max-w-4xl mx-auto">
                <div className="mb-6">
                  ...
                  <p className="text-[#00FF88] text-sm uppercase tracking-wide font-bold">
                    {selectedSkill} Module
                  </p>
                </div>
                  ...
                  {materialLoading ? (
                    <div className="flex flex-col items-center justify-center h-64">
                      ...
                      <p className="mt-4 text-gray-400 animate-pulse">
                        Generating personalized {activeTab}...
                      </p>
                    </div>
                  ) : (
