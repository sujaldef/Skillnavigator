      ...
      {links.map((link) => (
        <li key={link}>
          <a
            ...
            className="text-gray-400 hover:text-[#00FF88] text-sm transition-colors duration-200"
          >
            {link}
          </a>
        </li>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
        ...
        <div>
          ...
          <p className="text-gray-400 text-sm leading-relaxed mb-6">
            Empowering professionals to navigate their careers through
            personalized learning paths, assessments, and community support.
          </p>
